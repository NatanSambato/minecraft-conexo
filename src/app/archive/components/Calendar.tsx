  ...
  return (
    <DayPicker
      ...
      modifiers={{
        ...
        won: wonDays,
        playing: playingDays,
        todayAvailable: puzzleDays.filter(
          (d) =>
      ...
      classNames={{
        ...
        button_previous:
          "p-2 hover:bg-white/10 rounded-full transition-colors [&_svg]:fill-white cursor-pointer aria-disabled:opacity-30 aria-disabled:hover:bg-transparent aria-disabled:cursor-default",
        button_next:
          "p-2 hover:bg-white/10 rounded-full transition-colors [&_svg]:fill-white cursor-pointer aria-disabled:opacity-30 aria-disabled:hover:bg-transparent aria-disabled:cursor-default",
        ...
        day_button:
          "w-12 h-12 mx-auto flex items-center justify-center rounded-full hover:bg-white/10 transition-colors cursor-pointer",
        selected: "",
